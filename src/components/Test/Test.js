import React, {  useState, useEffect } from "react";
 ...
 export default function Test(){
     ...
     useEffect(()=>{
         ...
         axios.get("http://localhost:5272/Integral/getQuestions")
         .then(res =>{            
         ...
         axios.get("http://localhost:5272/Integral/getAnswers")
         .then(res =>{            
             setAnswers(res.data);
     ...
     function CheckResults(){
         ...
         axios.post("http://localhost:5272/Integral/checkAnswers", AnswerList)
         .then(res =>{
                 setMark(res.data);
         }).catch(error => console.log(error));
         setMarkShown(true);
